"""
Run live simulation with trained ANN baseline model
"""
import pygame
import torch
import numpy as np
...
def main():
    print("=== ANN Baseline Live Demo ===\n")
    
    # Initialize pygame
    pygame.init()
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    pygame.display.set_caption("ANN Baseline - Live Demo")
    ...
    try:
        model.load_state_dict(torch.load("checkpoints/ann_baseline.pt", map_location=DEVICE))
        model.eval()
        print("Model loaded successfully!\n")
    except FileNotFoundError:
        print("ERROR: Model not found. Please run train_baseline.py first.")
        return
